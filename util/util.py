...
def visualize(image_name, predictions, weight_name):
    ...
    for (i, pred) in enumerate(predictions):
        ...
        img.save('./SSRR_video/result/Pred/checkpoint_UNet_CBAM_IV/'+weight_name + '_' + image_name[i] + '.jpg')
...
def visualize_v2(image_name, predictions, weight_name):
    for (i, pred) in enumerate(predictions):
        ...
        img.save(f'./SSRR_video/result/Pred/checkpoint_UNet_CBAM_IV/{weight_name}_{image_name[i]}.png')
